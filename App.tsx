...
function App() {
 ...
 <div className="App-body">
  ...
  {navItems.map(item => (
    ...
    <Route path="/releases/:title/by/:artist/:name" element={<Release setCurrentTrack={setCurrentTrack} setCurrentTime={setCurrentTime} setDuration={setDuration}  setTxId={setTxId} />} />
</Routes>
