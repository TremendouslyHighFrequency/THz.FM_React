              ...
              <div className="App-body">
                ...
                <div className="page-content">
                  ...
                  <Routes>
                    ...
                    <Route path="/releases/:title/by/:artist/:name" element={<Release setCurrentTrack={setCurrentTrack} setTransaction={setTxId} setCurrentTime={setCurrentTime} setDuration={setDuration} />} />
                  </Routes>
