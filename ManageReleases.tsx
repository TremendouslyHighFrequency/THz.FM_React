        ...
        <div className="publishedReleases">
          <section className="container px-4 mx-auto">
            <div className="sm:flex sm:items-center sm:justify-between">
              <h2 className="text-lg font-medium text-gray-800">Releases:</h2>
              <div className="flex items-center mt-4 gap-x-3">
              <button className="flex items-center justify-center w-1/2 m-6 px-5 py-2 text-sm tracking-wide shadow-sm text-white transition-colors duration-200 bg-blue-500 rounded-lg shrink-0 sm:w-auto gap-x-2 hover:bg-blue-600 ">
    ...
    return (
      <div className="flex items-center mt-6 text-center border rounded-lg h-96">
        <div className="flex flex-col w-full max-w-sm px-4 mx-auto">
          ...
          <h1 className="mt-3 text-lg text-gray-800 ">No releases found</h1>
          <p className="mt-2 text-gray-500 ">You don't have any releases. Click the button to add one.</p>
