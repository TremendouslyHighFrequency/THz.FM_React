    ...
    try {
      ...
      if (await ergoConnector.nautilus.connect()) {
        ...
        const inputBox: InputBox = {
          "boxId": "f01ce99f8ff76c8b0a203dfc9fbaab4a41dff8a3e4919014cae86e2634c880f2",
          "transactionId": "17f244c3bc6da00cd433798ad10a5036b49ca6f88930d4a727323856e7cca7b0",
          "blockId": "5f28165d5a38bc18096c84d1a769d0577609e3fcc22899374690e28fc3a9c71b",
          "value": 1000000,
          "index": 0,
          "globalIndex": 33429427,
          "creationHeight": 1111859,
          "settlementHeight": 1111861,
  ...
  async function sendFilesToContract(setLoading) {
    try {
      ...
      if (await ergoConnector.nautilus.connect()) {
        ...
        let value = "1000000";
        const withdrawContract = "";

        const tokenId = "0fdb7ff8b37479b6eb7aab38d45af2cfeefabbefdc7eebc0348d25dd65bc2c91";

        let r4 = "0c410e0180897a240008cd03f68e2d2a05f62d2dcb3db017c62fcdd92c554ff6f31cc5acccb2157c63b45238";
        console.log("R4:", r4);
        let r5 = SColl(SColl(SByte), [tokenId]).toHex();
        console.log("R5:", r5);
        let r6 = SLong("1").toHex();
        ...
        let r7 = SColl(SPair(SColl(SByte), SLong), [["f01ce99f8ff76c8b0a203dfc9fbaab4a41dff8a3e4919014cae86e2634c880f2", 1]]).toHex();
