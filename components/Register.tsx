        ...
        <div className="signup-form mt-6 md:mt-12">
          ...
          <div className="border-2 border-solid rounded flex items-center mb-4">
            ...
            <div className="flex-1">
              <input type="text" placeholder="Username" className="h-10 py-1 pr-3 w-full"></input>
            </div>
          </div>
          ...
          <div className="border-2 border-solid rounded flex items-center mb-4">
            ...
            <div classname="flex-1">
              <input type="text" placeholder="E-mail" className="h-10 py-1 pr-3 w-full"></input>
            </div>
          </div>
          ...
          <div className="border-2 border-solid rounded flex items-center mb-4">
            ...
            <div className="flex-1">
              <input type="password" placeholder="Password" className="h-10 py-1 pr-3 w-full"></input>
            </div>
          </div>
